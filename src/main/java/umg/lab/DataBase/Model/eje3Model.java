...
public class eje3Model {
    ...
    // Constructor
    public eje3Model(int idEquipo, String nombre, String pais, String ciudad, String estadio, int fundacion,
                     String entrenador, String webOficial, String facebook, String twitter,
                     String instagram, String patrocinadorPrincipal, java.sql.Timestamp creadoEn) {
